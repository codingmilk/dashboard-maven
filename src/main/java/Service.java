...
public class Service {
    ...
    Map home(Service s) {
        ...
        map.put("pulsometer", pulsometer.get(secondsPassed));
        map.put("r", r.get(secondsPassed));
        map.put("g", g.get(secondsPassed));
        map.put("b", b.get(secondsPassed));
        map.put("EngineEff",decimalFormat.format(EngineEff.get(secondsPassed)));
        return map;
